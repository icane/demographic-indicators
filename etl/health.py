...
from etl.config_health import health_cfg as cfg
...
for key in cfg.series:
    ...
    df_cant = transform(df_cant, cfg.periods.global_health, 'Cantabria - ')
    ...
    df_esp = transform(df_esp, cfg.periods.global_health, 'España - ')
    ...
    df = transform(df, cfg.periods.health)
